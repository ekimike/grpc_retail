...
public class OrderMgtClient {
    ...
    private static final Logger logger =
            Logger.getLogger(OrderMgtClient.class.getName());
    ...
    public static void main(String ... args) {
        ...
        OrderManagementOuterClass.Order order =
                ...
                .newBuilder()
                .setId("101")
                .addItems("iPhone XS").addItems("MacBook Pro")
        ...
        //get order
        StringValue id =
                StringValue.newBuilder().setValue("101").build();
        OrderManagementOuterClass.Order orderResponse =
                stub.getOrder(id);
        ...
        while( matchingOrdersItr.hasNext() ) {
            OrderManagementOuterClass.Order matchingOrder =
                    matchingOrdersItr.next();
            logger.info("search order response -> matching reponse - " +
                    matchingOrder.getId());
            logger.info("Order :" +
                    order.getId() + "\n" +
    ...
    private static void invokeOrderUpdate(OrderManagementGrpc.OrderManagementStub asyncStub) {
        ...
        OrderManagementOuterClass.Order updOrder1 =
        ...
        OrderManagementOuterClass.Order updOrder2 =
                OrderManagementOuterClass.Order.newBuilder()
                .setId("103")
        ...
        OrderManagementOuterClass.Order updOrder3 =
                OrderManagementOuterClass.Order.newBuilder()
                .setId("104")
    ...
    private static void invokeOrderProcess(OrderManagementGrpc.OrderManagementStub asyncStub) {
        ...
        StreamObserver<OrderManagementOuterClass.CombinedShipment> orderProcessResponseObserver =
                new StreamObserver<OrderManagementOuterClass.CombinedShipment>() {
